# Topic: 0x13. C - More singly linked lists
...
*****************************************************************************************
## Learning Objectives
At the end of this project, you are expected to be able to explain to anyone [explain to anyone](https://fs.blog/feynman-learning-technique/), without the help of Google:
...
Your code should use the `Betty` style. It will be checked using betty-style.pl[ betty-style.pl](#https://github.com/holbertonschool/Betty/blob/master/betty-style.pl) and betty-doc.pl[betty-doc.pl](#https://github.com/holbertonschool/Betty/blob/master/betty-doc.pl)
...
## More Info
please use the data structure for this project:
```
/**
